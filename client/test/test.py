...
from utils.settings import ASSETS_PATH
...
class TextInput:
    ...
    def __init__(
        self, pos, screen_dimensions, text_color="white"
    ) -> None:
        self.prompt = '|'
        # position of chatlist and chatbox
        self.CHAT_BOX_POS = pg.Rect((pos[0], pos[1] + 500), (screen_dimensions[0], 400))
        self.CHAT_LIST_POS = pg.Rect(pos, (screen_dimensions[1], 40))
...
class Game:
    ...
    FPS = 50
    # Size of window
    SCREEN_WIDTH, SCREEN_HEIGHT = 1080*0.4, 1920*0.4
    BG_COLOR = "black"
